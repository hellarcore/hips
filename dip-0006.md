...
* [HIP 002: Special Transactions](https://github.com/hellarcore/dips/blob/master/dip-0002.md)
* [HIP 003: Deterministic Masternode Lists](https://github.com/hellarcore/dips/blob/master/dip-0003.md)
...
A merkle root of all active LLMQ sets is calculated and included into [DIP4 CbTx](https://github.com/hellarcore/dips/blob/master/dip-0004.md) with version >= 2.

## Signing sessions/requests

The details of the signing process are handled in [DIP007](https://github.com/hellarcore/dips/blob/master/dip-0007.md). The individual use cases for LLMQs are handled in specialized HIPs.

## Current LLMQ types

LLMQ types may be defined based on future HIPs. A list of registered LLMQ types can be found [here](dip-0006/llmq-types.md).
