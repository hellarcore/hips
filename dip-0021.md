...
* [Implement P2P messages QGETDATA <-> QDATA](https://github.com/hellarcore/hellar/pull/3953)
* [Implement DKG data recovery / quorum verification vector
  sync](https://github.com/hellarcore/hellar/pull/3964)
* [Add "mode" to -llmq-qvvec-sync parameter](https://github.com/hellarcore/hellar/pull/4030)

# Copyright

Copyright (c) 2021 Hellar Core Inc. [Licensed under the MIT
