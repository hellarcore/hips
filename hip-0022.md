...
* [HIP-0024: LLMQ Distribution and Rotation](hip-0024.md)
...
[HIP-0006](https://github.com/hellarcore/hips/blob/master/hip-0006.md#parametersvariables-of-a-llmq-and-dkg))
...
defined in [HIP-0024](hip-0024.md) as opposed to the `LLMQ_50_60` quorum used by the previous
...
signing](https://github.com/hellarcore/hips/blob/master/hip-0024.md#choosing-the-active-quorum-to-perform-signing).
